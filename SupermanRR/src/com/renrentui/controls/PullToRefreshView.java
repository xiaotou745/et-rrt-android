...
/**
 * 包含ListView,GridView,ScrollView下拉刷新和上拉加载的自定义控件
 * @version landingtech_v1
 * @author Eric
 * @使用方法   类似布局控件，需要实现OnFooterRefreshListener OnHeaderRefreshListener接口
 */
public class PullToRefreshView extends LinearLayout {
	...
	private boolean isFooterOk = true;
	public boolean isFooterOk() {
		return isFooterOk;
	}

	public void setFooterOk(boolean isFooterOk) {
		this.isFooterOk = isFooterOk;
	}
...
//	private String mLastUpdateTime;
	...
	public PullToRefreshView(Context context,boolean isFooterOk) {
		super(context);
		this.isFooterOk = isFooterOk;
		this.context = context;
		init();
...
//				----------------------------------改过---------------------------------------------
	...
	public void onHeaderRefreshComplete() {
	    ...
	    mHeaderUpdateTextView.setText("上次更新于："+time);
		mHeaderState = PULL_TO_REFRESH;
	}
