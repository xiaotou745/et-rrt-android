...
public class WheelView extends View {
	...
	private static final int ADDITIONAL_ITEM_HEIGHT = 75;
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(getResources().getDimension(R.dimen._18sp));
		}
		...
		if (valuePaint == null) {
			...
			valuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
			valuePaint.setTextSize(getResources().getDimension(R.dimen._18sp));
		}
