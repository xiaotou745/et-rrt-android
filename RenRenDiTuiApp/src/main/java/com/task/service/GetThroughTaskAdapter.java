...
public void setThroughTaskData(List<MyTaskContentBean> finishedTaskInfos){
	...
	public View getView( int position, View convertView, ViewGroup parent) {
		...
		final MyTaskContentBean taskBean = (MyTaskContentBean) getItem(position);
		int type = getItemViewType(taskBean.taskType);
			switch (type){
				case 0:
					//签约
		...
		if(type==0){//签约
			...
			//viewholder_two.textView_4.setText(context.getResources().getString(R.string.my_task_list_itemt_4, taskBean.getComplateNum()));
			viewholder_two.btn_1.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View view) {
					//分享
					Intent mIntent = new Intent(context, ShareViewActivity.class);
					mIntent.putExtra("TASK_ID",taskBean.taskId);
					mIntent.putExtra("SHARE_CONTENT",taskBean.downUrl);
					mIntent.putExtra("scanTip",taskBean.scanTip);
					mIntent.putExtra("reminder",taskBean.reminder);
			...
			//viewholder_thread.textView_4.setText(context.getResources().getString(R.string.my_task_list_itemt_4, taskBean.getComplateNum()));
			viewholder_thread.btn_1.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View view) {
					//分享
					Intent mIntent = new Intent(context, ShareViewActivity.class);
					...
					mIntent.putExtra("scanTip",taskBean.scanTip);
					mIntent.putExtra("reminder",taskBean.reminder);
					mIntent.putExtra("taskStatus",taskBean.status);
					context.startActivity(mIntent);
